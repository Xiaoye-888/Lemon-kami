...
PAGE_CONTRACTS = [
    ...
    },
    {
        ...
        "source": "admin/src/views/AccountProfile.vue",
        "regions": [
            region("toolbar", 'class="page-toolbar"'),
            region("shell", 'class="account-shell"'),
            region("summary-card", 'class="panel account-summary"'),
            region("profile-head", 'class="profile-head"'),
            region("profile-descriptions", 'class="profile-descriptions"'),
            region("avatar-editor", 'class="avatar-editor"'),
        ],
        "ordered_regions": [
            region("toolbar", 'class="page-toolbar"'),
            region("shell", 'class="account-shell"'),
        ...
        "card_groups": [
            card_group("profile-fields", ("roleLabel", "profileAvatarUrl", "avatarText", "profile.username", "profile.id", "profile.email", "profile.phone", "formatBeijingTime", "formatOptionalTime")),
        ],
        "action_groups": [action_group("profile-actions", ("openEditDialog", "handleAvatarUpload", "saveProfile", "updateCurrentAccountProfile", "uploadCurrentAccountAvatar"))],
        "tables": [],
        "forbidden_tokens": ["安全设置", "原密码", "新密码", "确认新密码"],
    },
    {
        "id": "admin.account.password",
        "role": "admin",
        "route": "/admin/account/password",
        "source": "admin/src/views/AccountPassword.vue",
        "regions": [
            region("toolbar", 'class="page-toolbar"'),
            region("shell", 'class="account-shell"'),
            region("password-card", 'class="panel password-panel"'),
            region("password-form", 'class="password-form"'),
            region("password-actions", 'class="form-actions"'),
        ],
        "ordered_regions": [
            region("toolbar", 'class="page-toolbar"'),
            region("shell", 'class="account-shell"'),
        ...
        "card_groups": [
            card_group("password-fields", ("old_password", "new_password", "confirm_password", "updateCurrentAccountPassword")),
        ],
        "action_groups": [action_group("password-actions", ("savePassword", "updateCurrentAccountPassword", "loadProfile"))],
        "tables": [],
        "forbidden_tokens": ["基本信息", "上传头像", "资料编辑", "账号资料"],
    },
    {
        "id": "merchant.account.profile",
        "role": "merchant",
    ...
    },
    {
        ...
        "role": "merchant",
        "route": "/merchant/account/password",
        "source": "admin/src/views/AccountPassword.vue",
        "regions": [
            region("toolbar", 'class="page-toolbar"'),
            region("shell", 'class="account-shell"'),
