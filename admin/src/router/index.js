...
const adminChildren = [
  ...
  { path: 'commercial/merchants/:merchantId/detail', name: 'AdminMerchantDetail', component: () => import('../views/AdminMerchantDetail.vue'), meta: { title: '发卡用户详情' } },
  { path: 'commercial/merchants/:merchantId/batches', name: 'AdminMerchantBatches', component: () => import('../views/MerchantBatches.vue'), meta: { title: '发卡用户批次管理', adminMerchantScope: true } },
  ...
  { path: 'ops', name: 'AdminOps', component: () => import('../views/AdminOps.vue'), meta: { title: '运维中心' } },
...
const merchantChildren = [
  ...
  { path: 'apps/notices', name: 'MerchantAppNotices', component: () => import('../views/AppNotices.vue'), meta: { title: '公告管理' } },
  { path: 'apps/versions', name: 'MerchantAppVersions', component: () => import('../views/AppVersions.vue'), meta: { title: '版本更新' } },
